...
java -cp %t2o_classpath% -ms1200M -mx1200M -Dgate.home=%GATE% -Dgate.config=%GATE%/gate.xml -Dgate.plugins.home=%GATE%/plugins -Dload.plugin.path=file:/%GATE%/plugins/ANNIE -Djava.library.path=g:/text2onto/software/3rdparty/eclipse/os/win32/x86 -Dfile.encoding=ISO-8859-1 org.ontoware.text2onto.debug.TestAlgorithms file:/g:/corpus file:/g:/text2onto/software/ontology

 ...
 */
public class TFIDFInstanceExtraction extends AbstractInstanceExtraction {
	...
	protected double getProbability( POMObject object, int iReferences ){
		...
		// lDf_i: list of documents containing specific instance candidate "i"
		// dTfidf_ij: tfidf-value for certain instance candidate "i", based upon document "j"
		// tfidf_i: tfidf-value for certain instance candidate "i", normalized over whole document collection

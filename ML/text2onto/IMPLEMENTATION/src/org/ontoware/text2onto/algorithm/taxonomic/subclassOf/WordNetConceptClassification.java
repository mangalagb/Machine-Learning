 ...
 */  
public class WordNetConceptClassification extends AbstractSimpleAlgorithm implements AbstractConceptClassification {
	...
	protected List<ChangeRequest> getPOMChanges() throws Exception {
		...
		System.out.println( "WordNetConceptClassification.getPOMChanges: "+ changedConcepts );
		int iConcepts1 = 0;
	...
	private Double getProbability( POMSubclassOfRelation relation ) throws Exception { 
		...
		return m_wordNet.isHypernymOf( range.getLabel(), domain.getLabel() );	 
	} 
}
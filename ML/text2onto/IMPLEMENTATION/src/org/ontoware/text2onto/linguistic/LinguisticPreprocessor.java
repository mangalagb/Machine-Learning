...
public class LinguisticPreprocessor implements ChangeObserver, Serializable {
	...
	protected void init() throws Exception {
		...
		creoleURL = new URL( "file:" + System.getProperty( "gate.plugins.home", "/c:/HIWI/GATE/plugins" ) + "/Tools" );
		creoleRegister.addDirectory( creoleURL );
		creoleRegister.registerDirectories( creoleURL );

		creoleURL = new URL( "file:" + System.getProperty( "gate.plugins.home", "/c:/HIWI/GATE/plugins" ) + "/Stemmer" );
		creoleRegister.addDirectory( creoleURL );
		creoleRegister.registerDirectories( creoleURL );
